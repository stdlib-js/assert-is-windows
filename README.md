...
```
The previous example will load the latest bundled code from the deno branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/assert-is-windows/tags). For example,

```javascript
import IS_WINDOWS from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-windows@v0.2.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/assert-is-windows/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/assert-is-windows/actions/workflows/test.yml?query=branch:v0.2.0
...
[deno-readme]: https://github.com/stdlib-js/assert-is-windows/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/assert-is-windows/tree/umd
[umd-readme]: https://github.com/stdlib-js/assert-is-windows/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/assert-is-windows/tree/esm
[esm-readme]: https://github.com/stdlib-js/assert-is-windows/blob/esm/README.md
